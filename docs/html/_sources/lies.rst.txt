...
First, we show a traceback generated with ``verbosity level`` set to 0:
...
Next, we show a traceback generated with ``verbosity level`` set to 9:
...
Here's the **true** Python traceback generated (displayed with ``verbosity`` 0)
